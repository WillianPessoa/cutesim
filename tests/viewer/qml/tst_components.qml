...
Item {
    ...
    TestCase {
        ...
        function test_zero_padded() {
            var c = createTemporaryObject(tickChipComp, this, {
                                              tick: 0
                                          });
            verify(c !== null, "TickChip creation failed");
            var num = findChild(c, "num");
            if (num)
                compare(num.text, "000");
            else
                skip("num id not found in TickChip");
        }
        ...
        function test_value_padded() {
            ...
            var num = findChild(c, "num");
            if (num)
                compare(num.text, "042");
            else
                skip("num id not found");
        }
    ...
    TestCase {
        ...
        function test_connected_label() {
            var c = createTemporaryObject(statusComp, this, {
                                              status: "connected"
                                          });
            verify(c !== null);
    ...
    TestCase {
        ...
        function test_wide_table_needs_no_hscroll() {
            var c = createTemporaryObject(tableComp, this, {
                                              width: 900
                                          });
