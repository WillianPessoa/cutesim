...
TEST(Validation, DeviceProbsNotSummingToHundredIsError) {
    char *argv[] = { (char *)"rr-feedback", (char *)"--p-disk=50", (char *)"--p-tape=30",
...
TEST(DeviceProb, DiskAndTapeSetPrinterGetsRemainder) {
    char *argv[] = { (char *)"rr-feedback", (char *)"--p-disk=50", (char *)"--p-tape=30", nullptr };
    int error    = 0;
    SimConfig cfg = parse_args(3, argv, &error);
    EXPECT_EQ(error, 0);
    EXPECT_EQ(cfg.p_printer, 20);
...
TEST(DeviceProb, DiskAndPrinterSetTapeGetsRemainder) {
    char *argv[]  = { (char *)"rr-feedback", (char *)"--p-disk=40", (char *)"--p-printer=35",
                      nullptr };
    int error     = 0;
    SimConfig cfg = parse_args(3, argv, &error);
    EXPECT_EQ(error, 0);
...
TEST(DeviceProb, TapeAndPrinterSetDiskGetsRemainder) {
    char *argv[]  = { (char *)"rr-feedback", (char *)"--p-tape=60", (char *)"--p-printer=10",
                      nullptr };
    int error     = 0;
    SimConfig cfg = parse_args(3, argv, &error);
    EXPECT_EQ(error, 0);
