...
Item {
    ...
    Component.onCompleted: if (bridge) bundled = bridge.bundledScenarios()
                    ...
                    GridLayout {
                        ...
                        ColumnLayout {
                            ...
                            RowLayout {
                                ...
                                FieldTag { text: "high" }
                                SpinBox {
                                    boxWidth: 96; minimumValue: 1; maximumValue: 20
                                    value: root.quantumHi
                                    onValueChanged: root.quantumHi = value
                                }
                                FieldTag { text: "low"; Layout.leftMargin: 8 }
                                SpinBox {
                                    boxWidth: 96; minimumValue: 1; maximumValue: 20
                        ...
                        ColumnLayout {
                            ...
                            RowLayout {
                                ...
                                SpinBox {
                                    boxWidth: 96; minimumValue: root.serviceMin; maximumValue: 100
                    ...
                    ColumnLayout {
                        ...
                        Repeater {
                            ...
                            delegate: Rectangle {
                                ...
                                radius: 8
                                color: active ? Qt.rgba(Theme.accent.r, Theme.accent.g, Theme.accent.b, 0.10)
                                              : (bundledHov.hovered ? Theme.hover : Theme.cardBg)
                                border.width: 1
                                ...
                                HoverHandler { id: bundledHov; cursorShape: Qt.PointingHandCursor }
                                TapHandler { onTapped: root.setScenario(bundledItem.modelData.path) }
                            }
                        }
                        Text {
