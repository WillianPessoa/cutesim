...
QtObject {
    ...
    function toggle() { mode = isDark ? "light" : "dark" }
    ...
    readonly property color cardBg:       isDark ? Qt.rgba(0.07, 0.078, 0.118, 0.72)
                                                 : Qt.rgba(1, 1, 1, 0.82)
    readonly property color cardBgSolid:  isDark ? "#14161f" : "#ffffff"
    readonly property color cardBorder:   isDark ? Qt.rgba(1, 1, 1, 0.06)
                                                 : Qt.rgba(0.06, 0.09, 0.16, 0.08)
    readonly property color cardBorderHi: isDark ? Qt.rgba(1, 1, 1, 0.12)
                                                 : Qt.rgba(0.06, 0.09, 0.16, 0.16)
    readonly property color headerBg:     isDark ? Qt.rgba(0.04, 0.043, 0.07, 0.85)
                                                 : Qt.rgba(1, 1, 1, 0.85)
    readonly property color hover:        isDark ? Qt.rgba(1, 1, 1, 0.04)
                                                 : Qt.rgba(0.06, 0.09, 0.16, 0.04)
    readonly property color hoverStrong:  isDark ? Qt.rgba(1, 1, 1, 0.08)
                                                 : Qt.rgba(0.06, 0.09, 0.16, 0.08)
    readonly property color divider:      isDark ? Qt.rgba(1, 1, 1, 0.06)
                                                 : Qt.rgba(0.06, 0.09, 0.16, 0.08)
    ...
    readonly property color accentSoft: isDark ? Qt.rgba(0.48, 0.635, 1.0, 0.16)
                                               : Qt.rgba(0.114, 0.357, 0.851, 0.12)
    readonly property color accentGlow: isDark ? Qt.rgba(0.48, 0.635, 1.0, 0.30)
                                               : Qt.rgba(0.114, 0.357, 0.851, 0.22)
